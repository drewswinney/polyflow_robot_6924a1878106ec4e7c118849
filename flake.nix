{
  ...
  let
    ...
    # Overlay: pin grafana-loki to 2.9.x (Loki 3.4.x has single-node memberlist regressions)
    pinLoki29 = final: prev: {
      grafana-loki = prev.grafana-loki.overrideAttrs (old: rec {
        version = "2.9.11";
        src = prev.fetchFromGitHub {
          owner = "grafana";
          repo = "loki";
          rev = "v${version}";
          # Fill this in after first build; Nix will print the correct hash.

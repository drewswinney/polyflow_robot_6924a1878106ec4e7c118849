...
let
  user      = "admin";
  password  = "password";
  hostname  = "6924a1878106ec4e7c118849";
  homeDir   = "/home/${user}";
...
in
{
  ...
  # This works even if you use NetworkManager for Wi-Fi.
  # systemd-networkd will just create a dummy netdev.
  ...
  services.loki = {
    enable = true;
    package = pkgs.grafana-loki; # pinned to Loki 2.9.x in flake overlay
